//
//  PTLPlaceholderView.swift
//  PTLPlaceholderView
//
//  Created by soliloquy on 2018/6/26.
...
class PTLPlaceholderView: UIView {
    
    //    static let instance: PTLPlaceholderView = PTLPlaceholderView()
    //    class func sharedInstance() -> PTLPlaceholderView {
    //        return instance
    //    }
    //
    // 单例
    static let `default` = PTLPlaceholderView()
...
extension PTLPlaceholderView {
    ...
    override func layoutSubviews() {
        ...
        let bW: CGFloat = bounds.size.width * 1/2
        let bH: CGFloat = bW
